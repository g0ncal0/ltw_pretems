...
('Orange Polo', 4, '2024-3-12', 4, 1, 'ModeloA', 1, 2, 16.3, 2, 1, 'This orange polo adds a burst of color to your wardrobe, offering a classic yet bold look for casual occasions.', 'img/products/p4_1.jpeg'),
('Jeans Trousers', 5, '2024-3-12', 2, 1, 'ModeloA', 1, 2, 16.3, 2, 1, 'These jeans are a wardrobe staple, offering timeless style and comfort for everyday wear.', 'img/products/trousers1-trousers-f1.jpg'),
('Pink Woman Trouser', 6, '2023-3-12', 2, 1, 'ModeloD', 4, 1, 40.3, 2, 1, 'These trousers add a pop of color to your wardrobe, with a flattering fit and versatile style that is perfect for any occasion.', 'img/products/p6_1.jpeg'),
('Super Dress', 7, '2024-6-12', 1, 2, 'ModeloJ', 2, 3, 60.3, 2, 1, 'This super dress is a showstopper, with its eye-catching design and flattering fit, perfect for making a statement at any event.', 'img/products/p7_1.gif'), 
...
('Shoe Sensation', 9, '2024-05-15 12:00:00', 3, 3, 'Model 3', 4, 3, 100.00, 3, 1, 'These shoes blend fashion and comfort seamlessly, making them a perfect choice for any occasion.', 'img/products/shoe1-shoe-f1.jpg'),
('T-Shirt Triumph', 10, '2024-05-15 12:00:00', 4, 1, 'Model 4', 1, 2, 125.00, 1, 1, 'This t-shirt offers relaxed style and all-day comfort, perfect for everyday wear and easy pairing with your favorite bottoms.', 'img/products/black1-tshirt-f1.jpg'),
...
('Tailored Trouser Ensemble', 12, '2024-05-15 12:00:00', 2, 2, 'Model 2', 3, 2, 75.00, 1, 1, 'These tailored trousers offer a sleek, polished look, perfect for both professional settings and upscale events.', 'img/products/trousers3-trouser-f1.jpg'),
('Sneaker Style Statement', 13, '2024-05-15 12:00:00', 3, 3, 'Model 3', 4, 3, 100.00, 2, 1, 'Step up your style with these versatile sneakers, combining comfort and fashion for any occasion.', 'img/products/shoe2-shoe-f1.jpg'),
('Graphic Tee Treasure', 14, '2024-05-15 12:00:00', 4, 1, 'Model 4', 1, 2, 125.00, 2, 1, 'This graphic tee speaks volumes with its bold design, adding a splash of personality to any casual outfit.', 'img/products/nyc-tshirt-f1.jpg'),
('Casual Day Dress', 15, '2024-05-15 12:00:00', 1, 1, 'Model 1', 2, 1, 50.00, 1, 1, 'Comfy casual dress made from soft, breathable fabrics with simple designs.', 'img/products/dress2-dress-f1.jpg'),
('Cargo Pant Classic', 16, '2024-05-15 12:00:00', 2, 2, 'Model 2', 3, 2, 75.00, 1, 1, 'Cargo pants with pockets aplenty, ready for any adventure.', 'img/products/trousers4-trousers-f1.jpg'),
('Athletic Shoe Adventure', 17, '2024-05-15 12:00:00', 3, 3, 'Model 3', 4, 3, 100.00, 2, 1, 'These athletic shoes offer top-notch support and style, perfect for conquering workouts or simply staying active with comfort and flair.', 'img/products/shoe3-shoe-f1.jpg'),
('Vintage Tee Vibe', 18, '2024-05-15 12:00:00', 4, 1, 'Model 4', 1, 2, 125.00, 2, 1, 'Embrace vintage vibes with this faded print t-shirt, effortlessly blending nostalgia with contemporary style.', 'img/products/vintage1-tshirt.jpg'),
('Formal Occasion Dress', 19, '2024-05-15 12:00:00', 1, 1, 'Model 1', 2, 1, 50.00, 3, 1, 'Formal occasion dress designed for special events.', 'img/products/dress3-dress-f1.jpg'),
('Denim Dream Trousers', 20, '2024-05-15 12:00:00', 2, 2, 'Model 2', 3, 2, 75.00, 1, 1, 'These trousers combine the timeless appeal of denim with a tailored fit, offering both comfort and style for a versatile addition to your wardrobe.', 'img/products/trousers5-trousers-f1.jpg'),
('Boot Beauty', 21, '2024-05-15 12:00:00', 3, 3, 'Model 3', 4, 3, 100.00, 3, 1, 'Step out in style with these classic boots, crafted for durability and fashion-forward flair, making them perfect for any season and any outfit.', 'img/products/shoe4-shoe-f1.jpg'),
...
('Slim Fit Slacks', 24, '2024-05-15 12:00:00', 2, 2, 'Model 2', 3, 2, 75.00, 2, 1, 'These slim fit slacks boast a tailored silhouette and premium fabric, offering both style and comfort for any professional or formal occasion.', 'img/products/trousers6-trousers-f1.jpg'),
('Heel Haven', 25, '2024-05-15 12:00:00', 3, 3, 'Model 3', 4, 3, 100.00, 3, 1, 'Elevate your look with these chic heels featuring a classic design and comfortable fit.', 'img/products/shoe5-shoe-f1.jpg'),
('V-neck Versatility T-Shirt', 26, '2024-05-15 12:00:00', 4, 1, 'Model 4', 1, 2, 125.00, 2, 1, 'This V-neck tee offers a relaxed fit and soft fabric for everyday comfort and style, a versatile essential for any wardrobe.', 'img/products/vneck1-tshirt-f3.jpeg'),
...
('Jogger Jean Jamboree', 28, '2024-05-15 12:00:00', 2, 2, 'Model 2', 3, 2, 75.00, 2, 1, 'These jogger jeans blend comfort and style seamlessly, featuring a relaxed fit.', 'img/products/trousers7-trousers-f1.jpg'),
('Sandal Splendor', 29, '2024-05-15 12:00:00', 3, 3, 'Model 3', 4, 3, 100.00, 3, 1, 'Slip into these stylish sandals for effortless comfort and a touch of laid-back charm, perfect for sunny days and beach outings.', 'img/products/shoe6-shoe-f1.jpg'),
